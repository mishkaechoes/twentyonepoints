package or.jhipster.health

import or.jhipster.health.config.ApplicationProperties
import or.jhipster.health.config.addDefaultProfile
...
class TwentyOnePointsApp(private val env: Environment) : InitializingBean {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<TwentyOnePointsApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(TwentyOnePointsApp::class.java)
