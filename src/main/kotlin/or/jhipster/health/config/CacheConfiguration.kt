...
class CacheConfiguration(jHipsterProperties: JHipsterProperties) {
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, or.jhipster.health.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, or.jhipster.health.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, or.jhipster.health.domain.User::class.java.name)
            createCache(cm, or.jhipster.health.domain.Authority::class.java.name)
            createCache(cm, or.jhipster.health.domain.User::class.java.name + ".authorities")
